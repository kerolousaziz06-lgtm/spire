...
// One trunk splitting into branches: the Sankey, reduced to a glyph.
export const IconFlow = (p: IconProps) => (
  <Svg {...p}>
    <path d="M3 12 H8" />
    <path d="M8 12 C12 12, 12 5, 16 5 H21" />
    <path d="M8 12 C12 12, 12 12, 16 12 H21" />
    <path d="M8 12 C12 12, 12 19, 16 19 H21" />
  </Svg>
);
